...
%  observed data by the Quantile Delta Mapping (DQM) method, as 
%  described by Cannon et al. (2015). Correction is performed to daily, 
%  monthly or annual data in a single location. An independent probability 
%  distribution function is assigned to  each sub-annual period based on 
...
QDM_series = QDM_series(:);

% 9) Concat QM (hsitorical) and QDM (future)
QDM_series = [QM_series' QDM_series']';
