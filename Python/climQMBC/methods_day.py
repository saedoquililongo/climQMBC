...
from .utils_day import formatQM, getStats, getDist, getCDF, getCDFinv
from scipy.signal import detrend
import scipy.stats as stat
import numpy as np


def QM_day(obs, mod, allow_negatives=1, frq='A', pp_threshold=1, pp_factor=1/100, user_pdf=False, pdf_obs=None, pdf_mod=None, win=1):
    """
